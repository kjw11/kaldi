...
if [ "$use_existing_models" == "true" ]; then
  for f in $plda_xvec_dir/mean.vec $plda_xvec_dir/pca_plda ; do
  ...
  run.pl $plda_xvec_dir/log/pca.log \
    ...
    $plda_xvec_dir/transform_pca.mat || exit 1;

  run.pl $plda_xvec_dir/log/pca_plda.log \
    ivector-compute-plda ark:$plda_data_dir/spk2utt \
    "ark:ivector-subtract-global-mean scp:$plda_xvec_dir/xvector.scp ark:- | transform-vec $plda_xvec_dir/transform_pca.mat ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
...
run.pl $scores_dir/log/lda_plda_scoring.log \
  ivector-plda-scoring --normalize-length=true \
    ...
    "ark:ivector-mean ark:$enroll_data_dir/spk2utt scp:$enroll_xvec_dir/xvector.scp ark:- | ivector-subtract-global-mean $plda_xvec_dir/mean.vec ark:- ark:- | transform-vec $plda_xvec_dir/transform_pca.mat ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
    "ark:ivector-subtract-global-mean $plda_xvec_dir/mean.vec scp:$test_xvec_dir/xvector.scp ark:- | transform-vec $plda_xvec_dir/transform_pca.mat ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
